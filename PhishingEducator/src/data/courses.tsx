import CommonGroundLesson1 from "../pages/Dashboard/Courses/CommonGround/Lesson1";
import CommonGroundLesson2 from "../pages/Dashboard/Courses/CommonGround/Lesson2";
